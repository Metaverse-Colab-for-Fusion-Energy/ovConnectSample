...
-- static lib projects don't appear to be happy with sourcelink... Look into this later
...
for k,v in ipairs(boostMatches) do
    ...
    print("Found Boost version "..boostVer.." from include folder: "..v)
end
